...
$start .= " 00:00:00";
try {
  $count = "select count(*) as count,sum(if(driver_invoice_id>0,1,0)) as redayOrders from orders";
...
print_r(json_encode(array('orders' => $orders, "redayOrders" => $redayOrders, "success" => $success, "data" => $data, 'pages' => $pages, 'nextPage' => $page + 2)));
