...
if($v->passes()) {
  ...
  if($result > 0){
    ...
    $mdata = sendNotification([$res[0]['s_token'],$res[0]['c_token']],[$order_id],'رساله جديد ',$message,"../orderDetails.php?o=".$order_id);
    $success = 1;
    }
...
ob_end_clean();
echo json_encode(['code'=>200,'message'=>$msg,'success'=>$success,'error'=>$error,$mdata],JSON_PRETTY_PRINT);
?>