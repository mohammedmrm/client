...
try {
    $sql30 = "select
                ...
                SUM(IF (order_status_id = '9' and storage_id<>1 and storage_id<>24,1,0)) as  inprocess,
                SUM(IF (order_status_id = '6' and storage_id<>1 and storage_id<>24,1,0)) as  partiallyReturnd,
                SUM(IF (order_status_id = '5' and storage_id<>1 and storage_id<>24,1,0)) as  `replace`,
    ...
    $sql7 = "select
                ...
                SUM(IF (order_status_id = '9' and storage_id<>1 and storage_id<>24,1,0)) as  inprocess,
                SUM(IF (order_status_id = '6' and storage_id<>1 and storage_id<>24,1,0)) as  partiallyReturnd,
                SUM(IF (order_status_id = '13' and storage_id<>1 and storage_id<>24,1,0)) as  `resend`,
                SUM(IF (order_status_id = '8' and storage_id<>1 and storage_id<>24,1,0)) as  `change`,
                SUM(IF (order_status_id = '5' and storage_id<>1 and storage_id<>24,1,0)) as  `replace`,
                SUM(IF ((order_status_id = '9') and (storage_id=1 or storage_id=24),1,0)) as  instorageReturnd,
                SUM(IF ((order_status_id = '6') and (storage_id=1 or storage_id=24),1,0)) as  instoragepartiallyReturnd,
                SUM(IF ((order_status_id = '5') and (storage_id=1 or storage_id=24),1,0)) as  instoragereplace,
                SUM(IF (order_status_id = '4',1,0)) as  recieved,
                SUM(IF (order_status_id = '7',1,0)) as  posponded,
               sum(
                     if(orders.order_status_id = 4 or orders.order_status_id = 6 or orders.order_status_id = 5,
