      ...
      <div class="content">
        <form id="searchForm">
          <div class="col-12">
            ...
            <div class="input-group mb-2">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1">رقم الكشف</span>
              </div>
              <input type="text" name="invoice" id="invoice" class="datepicker form-control" placeholder="رقم الكشف">
            </div>
                ...
                <div class="clear text-right" >
                    <div  class="content-boxed  ${bg} bottom-20">
                        <div class=" content bottom-15">
                            ...
                            <h6 class="text-center text-white bold font-14 top-5 bottom-0">${this.orders} طلبيه </h6>
                            <h6 class="text-center bold font-14 top-5 bottom-0"> رقم الكشف ${this.id} </h6>
                        </div>
                    '</div>
                </div>
              </a>`
