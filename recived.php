    ...
    <div class="page-content header-clear-medium">
      ...
      <div class="content-boxed">
        <div class="content bottom-0">
          ...
          <h5 class="bolder text-right">يمكن التحاسب عليها<span id="orders_ready"></span></h5>
        </div>
    ...
    function getorders(action) {
      ...
      $.ajax({
        ...
        success: function(res) {
          ...
          $("#orders_ready").text(" ( " + res.redayOrders + " ) ");
          console.log(res);
          $.each(res.data, function() {
            if (this.order_status_id == 9) {
              ...
              color = 'bg-red1-light';
            } else if (this.order_status_id == 4 && this.driver_invoice_id == 0) {
